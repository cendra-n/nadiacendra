...
import cardAsset from "@/assets/lanyard/card.glb.asset.json";
import lanyardAsset from "@/assets/lanyard/lanyard.png.asset.json";
import frontAsset from "@/assets/lanyard/lanyard-front.png.asset.json";

const cardGLB = cardAsset.url;
const lanyard = lanyardAsset.url;
const frontImage = frontAsset.url;
