...
function buildFrontTexture(dark: boolean): string {
  ...
  const lines = ["Gracias", "por visitar", "mi portfolio."];
...
export function LanyardCard() {
  ...
  useEffect(() => {
    setMounted(true);
    const build = () =>
      setFrontImage(buildFrontTexture(document.documentElement.classList.contains("dark")));
    build();
