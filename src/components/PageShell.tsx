    ...
    <div className="relative min-h-screen bg-background text-foreground antialiased">
      <header className="sticky top-0 z-40 border-b border-foreground/10 bg-background/85 backdrop-blur-sm">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-6 py-4 md:px-10">
          <Link
            to="/"
            className="group inline-flex items-center gap-1.5 rounded-full border border-primary bg-primary px-3.5 py-1.5 font-mono text-[11px] uppercase tracking-[0.16em] text-primary-foreground transition-colors hover:bg-transparent hover:text-primary"
          ...
          <nav className="flex flex-wrap items-center gap-2 md:gap-2.5">
            {sections.map((s) => (
              <Link
                key={s.to}
                to={s.to}
                className="inline-flex items-center rounded-full border border-primary bg-primary px-3.5 py-1.5 font-mono text-[11px] uppercase tracking-[0.16em] text-primary-foreground transition-colors hover:bg-transparent hover:text-primary"
              >
                {s.label}
              </Link>
            ))}
